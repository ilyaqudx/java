...
<link class="lfr-css-file" href="res/main_003.css" rel="stylesheet" type="text/css">
</head>
<body
...
.search_list ul li:hover {
  ...
  <script type="text/javascript">
  		...
  		var deleteGame = function(id){
  			...
  			if(flag){
  				...
  				window.open("game_delete?gameInfo.id="+id,"_self");
  				return true;
  			}
  ...
  <!-- 添加页面 -->
  	...
  	<div class="regin_form" 
    	...
    	<a href="game_input"><img style="margin-left: 35px;margin-bottom: 10px;" src="res/add.png"/></a>
    	<table id="game_table" border="1" align="center">
    		<tr class="trBg">
    			<td width="100px" align="center"><font size="3" color="white">Logo</font></td>
    			<td width="80px" align="center"><font size="3" color="white">游戏名称</font></td>
    			<td width="80px" align="center"><font size="3" color="white">游戏版本</font></td>
    			<td width="80px" align="center"><font size="3" color="white">游戏类型</font></td>
    			<td width="80px" align="center"><font size="3" color="white">下载次数</font></td>
    			<td width="80px" align="center"><font size="3" color="white">最小SDK</font></td>
    			<td width="80px" align="center"><font size="3" color="white">开发者</font></td>
    			<td width="160px" style="table-layout:fixed" align="center"><font size="3" color="white">游戏介绍</font></td>
    			<td width="80px" align="center"><font size="3" color="white">操作</font></td>
    		</tr>
    		<s:iterator value="#games">
	    		<tr>
	    			...
	    			<td width="100px" align="center">
	    				<img width="80px;" height="50px;" alt="Logo" src="logo/<s:property value="logo.name"/>"></br>
	    				<a href="javascript:changeLogo(<s:property value="id"/>)">修改Logo</a>
	    			</td>
	    			<td width="80px" align="center"><font size="2"><s:property value="name"/></font></td>
	    			<td width="80px" align="center"><font size="2"><s:property value="version"/></font></td>
	    			<td width="80px" align="center"><font size="2"><s:property value="style.styleName"/></font></td>
	    			<td width="80px" align="center"><font size="2"><s:property value="download_Times"/></font></td>
	    			<td width="80px" align="center"><font size="2"><s:property value="minSDK.version"/></font></td>
	    			<td width="80px" align="center"><font size="2"><s:property value="dev.name"/></font></td>
	    			<td width="160px" style="table-layout:fixed" align="center"><font size="2"><s:property value="discription"/></font></td>
	    			<td width="80px" align="center"><font size="2">
	    				<a href="game_edit?gameInfo.id=<s:property value="id"/>">编辑</a>
	    				<a href="#" onclick="return deleteGame(<s:property value="id"/>)">删除</a></br></br>
	    				<a href="#" onclick="showImg(<s:property value="id"/>)">查看图片</a>
	    			</font></td>
	    		</tr>
    		</s:iterator>
    	</table>
