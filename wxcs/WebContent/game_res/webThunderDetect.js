...
if(platform == "MacIntel"){
    incase_body_null();
    var g_mac_thunder_plugin = document.getElementById(g_thunderPluginId);
    if(g_mac_thunder_plugin == null){ //判断是否已经注入过插件对象
        //注入Plugin object
...
function wtd_ChangFolder(pid)
{
 ...
 {
   var game_pids = {'51185':'51185','48895':'48895','00192':'00192','19985':'19985','122127':'122127','00907':'00907','01012':'01012','01045':'01045','129236':'129236','00033':'00033'};
   if(game_pids[pid])
   {
	  return "http://hezuo.down.xunlei.com/xunlei_hezuo_game/thunder("+pid+").exe";
   }
...
function OnDownloadClick(sDownloadURL,sResName, sRefPage,sPid,isOpenNewWindow,sType,selectType){
  ...
  if(rand(1) == 1 && sResName !="tcfc") { //show(sDownloadURL,sPid);
	...
	linkObj.hide();
        ...
        if(browserName == 'MacBrowser')//mac handle
        {
        ...
        else if(isShowQrcodeDashboard(sPid))
        {
            loadQrDashBoardCss();
...
{
    var qrcode_ids = {'12023':'12023','03821':'03821','37826':'37826','02503':'02503','106069':'106069','50552':'50552','131181':'131181','05455':'05455','130465':'130465','00888':'00888','987285':'987285','45639':'45639','104290':'104290','19116':'19116','45650':'45650','131553':'131553','127891':'127891','21319':'21319','13853':'13853','04130':'04130','03247':'03247','16214':'16214','30540':'30540','49605':'49605','103492':'103492','04573':'04573','37897':'37897','35008':'35008','47035':'47035'};
    if(qrcode_ids[sPid])
        return true;
    else
        return false;
...
{
    try{
        var url = "http://stat.download.xunlei.com:8080/?aid=1008&id="+upid+'&click=1&t='+(new Date());
        var image = new Image();
        image.src=url;
    } catch(e) { }
}
...
function GetUserBrowser(){
    ...
    //判断是否为mac
    if(/macintosh/i.test(browserName) && (/chrome/i.test(browserName) || /firefox/i.test(browserName) || /Safari/i.test(browserName)))
    {
