...
.search_list ul li:hover {
  ...
  <script type="text/javascript">
  		...
  		var deleteImg = function(id){
  			...
  			if(flag){
  				...
  				window.open("/image_delete?img.id="+id,"_self");
  				return true;
  			}
  ...
  <!-- 添加页面 -->
  	...
  	<div class="regin_form" 
    	...
    	<a href="image_input"><img style="margin-left: 35px;margin-bottom: 10px;" src="res/add.png"/></a>
    	<table id="img_table" border="1" align="center">
    		<tr class="trBg">
    			<td width="360px" style="table-layout:fixed" align="center"><font size="3" color="white">图片名称</font></td>
    			<td width="180px" align="center"><font size="3" color="white">图片</font></td>
    			<td width="180px" align="center"><font size="3" color="white">操作</font></td>
    		</tr>
    		<s:iterator value="#imgs">
	    		<tr>
	    			<td width="160px" style="table-layout:fixed" align="center"><font size="2"><s:property value="imageName"/></font></td>
	    			<td width="160px" style="table-layout:fixed" align="center">
	    				<img width="160px;" height="60px;" src="upload/<s:property value="imageName"/>"/>
	    			</td>
	    			<td width="80px" align="center"><font size="2">
	    				<a href="image_edit?img.id=<s:property value="id"/>">编辑</a>
	    				<a href="#" onclick="return deleteImg(<s:property value="id"/>)">删除</a>
	    			</font></td>
	    		</tr>
    		</s:iterator>
    	</table>
