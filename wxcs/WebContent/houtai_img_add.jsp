...
.search_list ul li:hover {
  ...
  <!-- 添加页面 -->
  	<div class="regin_form" 
  	 ...
  	 <s:form id="img_add_form" action="img_save" method="POST">
  	 <s:hidden name="img.id"></s:hidden>
 	 <label style="font-size: 14px;margin-left: 150px;">图片名称:</label>
  	 <s:textfield  name="img.imageName"  style="border: 1px solid #88A5BB;font-size: 14px;
