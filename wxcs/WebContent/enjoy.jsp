...
.portlet-column-content {
	...
	<script type="text/javascript">
			...
			function shareToQQWb(obj){
				...
				var id = $(obj).find("span[cmd=shareToQQ_id]").text();
				var _t = name;
				
				var _url = 'http://shuobang1234.gicp.net:8088/wxcs/forum_childlist?forum.id='+id;
			...
			function shareTo139WB(obj){
				...
				var id = $(obj).find("span[cmd=shareTo139_id]").text();
				var share_link = 'http://shuobang1234.gicp.net:8088/wxcs/forum_childlist?forum.id='+id;
...
<div id="hot"
	...
	<li>
		...
		<a
			href="forum_childlist?forum.id=<s:property value="id"/>"
			title="<s:property value="name"/>"><img
			style="width: 72px; height: 72px;"
			src="upload/<s:property value="forumLogo.imageName"/>"></a>
	</div>
	<div class="app_new_listBox_info">
		<h3>
			<a
				...
				<s:property value="clickTimes"/> 人使用过)</span>
		</h3>
				...
				<div class="w_tool">
					<a title="分享到移动微博" class="shareTo share139" style="cursor: pointer;"
					 href="javascript:void(0);"	onclick="shareTo139WB(this)">
						...
						<span cmd="shareTo139_id" style="display:none;"><s:property value="id"/></span>
					...
					<a title="分享到腾讯微博" class="shareTo shareqq" style="cursor: pointer;" 
						...
						<span cmd="shareToQQ_id" style="display:none;"><s:property value="id"/></span>
					...
					<a title="分享到新浪微博" class="shareTo shareWeibo" style="cursor: pointer;">
						<wb:share-button count="n" title="<s:property value="name"/>"
						 url="http://shuobang1234.gicp.net:8088/wxcs/forum_childlist?forum.id=<s:property value="id"/>">
						 </wb:share-button>
					</a>
...
<!-- 下面从服务器获取最新的版块 -->
	<s:bean id="listCompara" name="cn.cid.cd.utils.ComparatorImpl" ></s:bean>
	<s:sort comparator="listCompara" source="#forums">
	<s:iterator>
	<li>
		<div class="app_new_listBox_img">
		<a
		...
		<div class="tool_article tool_share" id="hotfx1_1"
			...
			<div class="tool_slide" style="overflow: visible;"
				...
				<div class="w_tool">
					...
					<a title="分享到新浪微博" class="shareTo shareWeibo" style="cursor: pointer;">
						<wb:share-button count="n" title="<s:property value="name"/>"
						 url="http://shuobang1234.gicp.net:8088/wxcs/forum_childlist?forum.id=<s:property value="id"/>"></wb:share-button>
					</a>
					<span class="shareTo shareMore" id="_1"></span>
					<div class="shareMoreBox" style="display: none;"
						onclick="hottab2(1)" id="hotfx2_1">
