...
.search_list ul li:hover {
  ...
  <script type="text/javascript">
  		//删除游戏信息
  		var deleteDev = function(id){
  			var flag = confirm("确定要删除吗?");
  			if(flag){
  				//确定删除就执行请求操作,在当前的页面.其实最好用ajax异步提交请求.
  				window.open("/dev_delete?dev.id="+id,"_self");
  				return true;
  			}
  ...
  <!-- 添加页面 -->
  	...
  	<div class="regin_form" 
    	...
    	<a href="dev_input"><img style="margin-left: 35px;margin-bottom: 10px;" src="res/add.png"/></a>
    	<table id="dev_table" border="1" align="center">
    		<tr class="trBg">
    		...
    		<s:iterator value="#devs">
	    		<tr>
	    			<td width="160px" style="table-layout:fixed" align="center"><font size="2"><s:property value="name"/></font></td>
	    			<td width="80px" align="center"><font size="2">
	    				<a href="dev_edit?dev.id=<s:property value="id"/>">编辑</a>
	    				<a href="#" onclick="return deleteDev(<s:property value="id"/>)">删除</a>
	    			</font></td>
	    		</tr>
    		</s:iterator>
    	</table>
