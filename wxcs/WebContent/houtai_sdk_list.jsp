...
.search_list ul li:hover {
  ...
  <script type="text/javascript">
  		//删除游戏信息
  		var deleteSdk = function(id){
  			var flag = confirm("确定要删除吗?");
  			if(flag){
  				//确定删除就执行请求操作,在当前的页面.其实最好用ajax异步提交请求.
  				window.open("sdk_delete?sdk.id="+id,"_self");
  				return true;
  			}
  ...
  <!-- 添加页面 -->
  	...
  	<div class="regin_form" 
    	...
    	<a href="sdk_input"><img style="margin-left: 35px;margin-bottom: 10px;" src="res/add.png"/></a>
    	<table id="sdk_table" border="1" align="center">
    		<tr class="trBg">
    			<td width="360px" style="table-layout:fixed" align="center"><font size="3" color="white">SDK版本</font></td>
    			<td width="180px" align="center"><font size="3" color="white">操作</font></td>
    		</tr>
    		<s:iterator value="#sdks">
	    		<tr>
	    			<td width="160px" style="table-layout:fixed" align="center"><font size="2"><s:property value="version"/></font></td>
	    			<td width="80px" align="center"><font size="2">
	    				<a href="sdk_edit?sdk.id=<s:property value="id"/>">编辑</a>
	    				<a href="#" onclick="return deleteSdk(<s:property value="id"/>)">删除</a>
	    			</font></td>
	    		</tr>
    		</s:iterator>
    	</table>
